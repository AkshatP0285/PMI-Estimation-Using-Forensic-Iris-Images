...
metadata_file_path = '/DATA2/akshay/Akshat/sample_disjoint_datalist/mutispectral/'
output_dir = '/DATA2/akshay/Akshat/10_fold_results/multispectral_sam/'
checkpoint_dir = '/DATA2/akshay/Akshat/checkpoints/multispectral_sam_inc/'
...
def cleanup_old_checkpoints(fold, current_epoch, checkpoint_dir, keep_last_n=5):
    """
