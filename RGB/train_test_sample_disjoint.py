...
# Add after imports and before model setup
set_seed()
...
metadata_file_path = r'/DATA2/akshay/Akshat/sample_disjoint_datalist/RGB/'
output_dir = r'/DATA2/akshay/Akshat/10_fold_results/RGB_sample_disjoint/'
checkpoint_dir =  '/DATA2/akshay/Akshat/checkpoints/rgb_sam_dense/'
...
for fold in range(0, 10):
    ...
    train_dataloader = DataLoader(train_dataset, batch_size=batch_size, shuffle=True, num_workers=4, generator=g)
    test_dataloader = DataLoader(test_dataset, batch_size=batch_size, shuffle=False, num_workers=4, generator=g)
    val_dataloader = DataLoader(val_dataset, batch_size=batch_size, shuffle=False, num_workers=4, generator=g)
