...
metadata_file_path = '/DATA2/akshay/Akshat/train-test-data-list/multispectral/'
output_dir = '/DATA2/akshay/Akshat/10_fold_results/multispectral/'
checkpoint_dir = '/DATA2/akshay/Akshat/checkpoints/multispectral_inception/'
