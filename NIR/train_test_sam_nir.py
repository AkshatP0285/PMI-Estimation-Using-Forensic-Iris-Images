...
metadata_file_path = r'/DATA2/akshay/Akshat/sample_disjoint_datalist/NIR/'
output_dir = '/DATA2/akshay/Akshat/10_fold_results/NIR_Sam_Den/'
checkpoint_dir = '/DATA2/akshay/Akshat/checkpoints/nir_sam_dense/'
