...
embedding_cache_path = "/DATA2/akshay/Akshat/warsaw_dino_embeddings_rgb.npz"
...
for fold in range(1, 11):
    ...
    joblib.dump(mlp, f"mlp_model_sam_fold{fold}.joblib")
    joblib.dump(scaler, f"scaler_sam_fold{fold}.joblib")
